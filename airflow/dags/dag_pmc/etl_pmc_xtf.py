...
local_cfg_path = OTL_DIR / "etl" / "etl_pmc" / "config_pmc.json"
...
with DAG(
    ...
    inicio_etl = EmptyOperator(task_id="Inicio_ETL_LADM_PMC")
    ...
    fin_etl = EmptyOperator(task_id="Finaliza_ETL_LADM_PMC")
